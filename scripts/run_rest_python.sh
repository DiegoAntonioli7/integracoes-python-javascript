...
"$PYTHON3" -m locust -f locust/rest_python_locust.py --host http://localhost:8000 --users 20 --spawn-rate 20 --headless --run-time 60s --stop-timeout 5 --csv="$ROOT/rest/results/rest_python"
