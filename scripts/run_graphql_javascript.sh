...
"$PYTHON3" -m locust -f locust/graphql_javascript_locust.py --host http://localhost:3003 --users 20 --spawn-rate 20 --headless --run-time 60s --stop-timeout 5 --csv="$ROOT/graphql/results/graphql_javascript"
