...
"$PYTHON3" -m locust -f locust/soap_javascript_locust.py --host http://localhost:3002 --users 20 --spawn-rate 20 --headless --run-time 60s --stop-timeout 5 --csv="$ROOT/soap/results/soap_javascript"
